...
/* Generated from ../O.Common/vfel.dbd */
...
epicsShareExtern void (*pvar_func_register_func_vfelSimulatorAsubInit)(void);
epicsShareExtern void (*pvar_func_register_func_vfelSimulatorAsubProcess)(void);
epicsShareExtern void (*pvar_func_register_func_vfelLatticeAsubInit)(void);
epicsShareExtern void (*pvar_func_register_func_vfelLatticeAsubProcess)(void);
...
epicsShareExtern int *pvar_int_vfelSubDebug;
static struct iocshVarDef vardefs[] = {
	...
	{"vfelSubDebug", iocshArgInt, (void * const)pvar_int_vfelSubDebug},
	{NULL, iocshArgInt, NULL}
};

int vfel_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/home/tong/Programming/projects/vFEL/controlMachine";
    ...
    (*pvar_func_asSub)();
    (*pvar_func_register_func_vfelSimulatorAsubInit)();
    (*pvar_func_register_func_vfelSimulatorAsubProcess)();
    (*pvar_func_register_func_vfelLatticeAsubInit)();
    (*pvar_func_register_func_vfelLatticeAsubProcess)();
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"vfel_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    vfel_registerRecordDeviceDriver(*iocshPpdbbase);
}
